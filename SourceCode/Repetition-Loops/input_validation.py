...
#Declares a variable named done and assign it the value False
done = False

#A while loop that iterates as long as
#done is not equal to True
while not done :

  #Declares a variable named entry and prompt the user to
  #enter any value. Assigns the user's input to the entry variable.
  entry = input("Enter a value: ")

  #If the user entered the letter x, sets the done variable to True
  #Otherwise, prints the value of the entry variable.
  if entry == "x" :
    done = True
  else :
